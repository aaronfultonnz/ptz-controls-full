...
class CameraControl:
    def __init__(self, tk_root, config, general):
        ...
        self.port = 80 if 'port' not in config else config['port']
        ...
        self.move_speed_fast = 90 if 'move_speed_fast' not in general else general['move_speed_fast']
    ...
    def setup_presets(self):
        ...
        presets = self.camera.preset_list()
        self.preset_buttons = []
        i = 0
    ...
    def preset_click(self, preset_id):
        self.camera.preset_goto(preset_id)

    def get_frame(self):
        return self.frame

    def connect_to_camera(self):
        self.camera = ONVIFControl(host=self.host, port=self.port, username=self.username, password=self.password)
        self.camera.setup()
    ...
    def grab_frame(self):
        self.cap.grab()
        self.frame.after(10, self.grab_frame)
    ...
    def show_frame(self):
        ...
        self.preview.after(speed, self.show_frame)
